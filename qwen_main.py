...
from model import TargetModel, AttackerModel, Qwen
import copy
import numpy as np
import swanlab
    ...
    def crossover(self, parent1: Problem, parent2: Problem) -> Tuple[Problem, Problem]:
        ...
        if random.random() < self.crossover_rate:
            ...
            if random.random() < 0.5:
                ...
                child1.son_questions, child2.son_questions = parent1.son_questions.copy(), parent2.son_questions.copy()# 交换问题
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=["gemma-2-9b", "gemma-2-27b", "gpt-4o-mini", "gpt-4o", "Qwen2", "Qwen2.5-14B", "Qwen2.5-32B",
    ...
    file_out_path = './data/'+ arg.dataset + '/' + arg.dataset  +'_change.jsonl'
